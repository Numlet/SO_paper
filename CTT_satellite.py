...
CTT_satellite_dict=OrderedDict()
...
cube = iris.load(ukl.Obtain_name('/nfs/a201/eejvt/CASIM/THIRD_CLOUD/DM10/'+sub_folder,code))[0]
...
#hdf  =SD.SD(path+'MODIS/'+'MYD06_L2.A2015010.1640.006.2015012160803.hdf')
hdf  =SD.SD('/nfs/a201/eejvt/CASIM/SECOND_CLOUD/SATELLITE/MODIS/MOD06_L2.A2015060.1050.006.2015061055531.hdf')
hdf  =SD.SD('/nfs/a201/eejvt/CASIM/SECOND_CLOUD/SATELLITE/MODIS/MYD06_L2.A2015060.1630.006.2015062234245.hdf')
sds = hdf.select(SDS_NAME)
data = sds.get()
data=(data+15000)*0.009999999776482582
mask_value=-9999
