...
LF_IR_satellite_dict=OrderedDict()
LF_IR_satellite_dict_undeterminated=OrderedDict()
...
clear_fraction=np.array(data==0).sum()/float(data.size)
liquid_fraction=np.array(data==1).sum()/float(data.size)
ice_fraction=np.array(data==2).sum()/float(data.size)
undeterminated_fraction=np.array(data==6).sum()/float(data.size)
mixed_fraction=np.array(data==3).sum()/float(data.size)
...
LF_IR_satellite_dict['C3_SATELLITE']=(liquid_fraction)/cloud_fraction
LF_IR_satellite_dict_undeterminated['C3_SATELLITE']=(undeterminated_fraction+mixed_fraction)/cloud_fraction
...
cloud_fraction=liquid_fraction+undeterminated_fraction+ice_fraction
print 'CLOUD 1'
print 'liquid fraction',(liquid_fraction)/cloud_fraction
print 'undeterminated fraction',(undeterminated_fraction+mixed_fraction)/cloud_fraction
print 'ice fraction',(ice_fraction)/cloud_fraction

LF_IR_satellite_dict['C1_SATELLITE']=(liquid_fraction)/cloud_fraction
LF_IR_satellite_dict_undeterminated['C1_SATELLITE']=(undeterminated_fraction+mixed_fraction)/cloud_fraction
...
LF_IR_satellite_dict['C2_SATELLITE']=(liquid_fraction)/cloud_fraction
LF_IR_satellite_dict_undeterminated['C2_SATELLITE']=(undeterminated_fraction+mixed_fraction)/cloud_fraction
